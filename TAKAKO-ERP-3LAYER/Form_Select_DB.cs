...
{
    public partial class Form_Select_DB : Form
    {
        SYSTEM_DAL _systemDAL;

        public Form_Select_DB(SYSTEM_DAL _formLogin)
        {
            InitializeComponent();
        ...
        {
            cbxServerName.DisplayMember = "Text";
            cbxServerName.ValueMember = "Value";
            ...
            cbxServerName.DataSource = items;
        }
        ...
        private void btnSelectCompany_Click(object sender, EventArgs e)
        {
            try
            {
                _systemDAL.CompanyCode = cbxServerName.SelectedValue.ToString();
